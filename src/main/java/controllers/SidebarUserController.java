...
/**
 * Controller for the unified User sidebar (sidebarUSER.fxml).
...
public class SidebarUserController {
    ...
    private void loadAvatar() {
        ...
        if (avatarUrl != null && !avatarUrl.isEmpty()) {
            try {
                ...
                System.err.println("Erreur chargement avatar (sidebar user): " + e.getMessage());
                setDefaultAvatar();
            }
        } else {
            setDefaultAvatar();
    ...
    private void goToDashboard(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/homepage.fxml", "Accueil");
    }
    ...
    private void viewInvestments(ActionEvent event) {
        System.out.println("💼 Mes investissements — À implémenter");
    }

    @FXML
    private void viewMyStartup(ActionEvent event) {
        System.out.println("🏢 Ma startup — À implémenter");
    }

    @FXML
    private void goToAccompagnement(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/accompagnement.fxml", "Accompagnement");
    }

    @FXML
    private void goToDomaine(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/Domaine.fxml", "Domaines");
    }

    @FXML
    private void goToSession(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/Session.fxml", "Sessions");
    }
    ...
    @FXML
    private void handleFrontEvenementsView(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/FrontEvenementsView.fxml", "Front Événements");
    }

    @FXML
    private void goToFinancementFront(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/financement_front.fxml", "Financement");
    }



    @FXML
    private void showCandidatures(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/CandidatureFrontView.fxml", "CandidatureFront");
    }


    @FXML
    private void showDossiers(ActionEvent event) {
        NavigationHelper.navigateTo(getStage(event), "/fxml/DossierFrontView.fxml", "DossierFront");
    }
