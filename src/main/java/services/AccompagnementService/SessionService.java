...
public class SessionService {
    ...
    public List<Session> afficherAll() throws SQLException {
        ...
        String sql = """
            ...
            LEFT JOIN domaine d ON s.id_domaine = d.id_domaine
        ...
        try (Statement st = conn.createStatement();
            ...
            while (rs.next()) {
                ...
                if (rs.getString("nom_domaine") != null) {
                    domaine = new Domaine();
                    // IMPORTANT: conserver la clé primaire réelle
                    domaine.setId(rs.getInt("id_domaine"));
    ...
    public List<Session> rechercherParNom(String motCle) throws SQLException {
        ...
        while (rs.next()) {
            ...
            // Si on a un domaine lié, conserver aussi son id
            try {
                int domaineId = rs.getInt("id_domaine");
                if (!rs.wasNull()) {
                ...
                // La colonne id_domaine peut ne pas être sélectionnée dans certaines requêtes
            }
